...
public class Drivetrain extends Subsystem {
	...
	/**
	 * Default construtor for Drivetrain Singleton class
	 */
	private Drivetrain()
	{
	...
	/**
	 * Takes in a double as a speed and set it to the right motors
	 * @param speed is of type double from 1 to -1
	 */
	...
	/**
	 * Takes in a speed for the left and right ide of the drivetrain and
