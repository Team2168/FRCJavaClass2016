...
/**
 * The RobotMap is a mapping from the ports sensors and actuators are wired final into
...
public class RobotMap {
	...
	public static final boolean reversedLeft = false;
	public static final boolean reversedRight = true;
